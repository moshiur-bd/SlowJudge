...
<body>
	...
	<?php
		...
		while($row=mysqli_fetch_array($respid))
		{
			...
			echo "<tr class='dash' > <td class='dash ltr'> $ltr </td>    <td class='dash'> <a href='viewproblem.php?conid=$conid&pid=$pid&ltr=$ltr'> $pname</a> </td> <td class='dash tl'> $tl</td>  <td class='dash ml'> $ml</td>  <td class='dash sub'> <a href='submit.php?conid=$conid&pid=$pid' >submit</a> </td> <td class='dash cnt'> $slcnt</td> </tr>";
			$ltr++;
		}
		echo "</table>";
